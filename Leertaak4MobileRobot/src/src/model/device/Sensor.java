...
public abstract class Sensor extends Device {
        ...
        LaserMeasurement detectMeasure = null;
        ArrayList<LaserMeasurement> scanMeasures = new ArrayList<LaserMeasurement>();
        ...
        public void nextStep() {
                ...
                if(detect) {
                        ...
                        if(distance > -1.0)
                                scanMeasures.add(new LaserMeasurement(distance, localPosition.getT()));  // ??????????????
                }
        }
}
